...
class SocialSecurityTest < MiniTest::Test
  ...
  def atest_social_security
    ...
    # s_ means will be passed in as spouse_calc
    ...
    s_primary_as_primary_all = s_primary_calc.calculate_all_benefits(spouse_calc: partner_calc)
    s_partner_as_primary_all = s_partner_calc.calculate_all_benefits(spouse_calc: primary_calc)
  ...
  def test_social_security_spousal
    ...
    partner_benefit_a = partner_calc.calculate_benefit(start_month: month, spouse_calc: primary_calc)
    partner_benefit_b = partner_calc.calculate_benefit(start_month: month, spouse_calc: nil)
